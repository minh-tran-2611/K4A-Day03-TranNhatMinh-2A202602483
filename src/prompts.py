...
3. Nếu câu hỏi yêu cầu dữ liệu thời gian thực (hồ sơ học vụ, điểm số, lịch hẹn hoặc thông tin mới trên Internet), hãy gọi đúng Tool tương ứng với tham số chính xác. Dùng web_search cho thông tin cập nhật trên web.
